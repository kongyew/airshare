...
.factory('AzureCtrl', ['$cookieStore', '$rootScope', function ($cookieStore, $rootScope) {
 ...
 // azureMobileClient.azureMSC = new WindowsAzure.MobileServiceClient('https://developerweek.azure-mobile.net/', 'nQpITnITZsGULqGjymhntSfiesvxjU59');
